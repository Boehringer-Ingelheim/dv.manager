...
module_list <- list(
  ...
  "My Second Data table" = dv.listings::mod_data_table(
    dataset = dv.manager::mm_dispatch("filtered_dataset", "adsl"),
    module_id = "mod2"
  )
)
...
module_list <- list(
  ...
  "Cool-named module" = dv.listings::mod_data_table(
    dataset = dv.manager::mm_dispatch("filtered_dataset", "adsl"),
    module_id = "mod2"
  )
)
...
module_list <- list(
  ...
  "ADAE data table" = dv.listings::mod_data_table(
...
module_list <- list(
  ...
  "ADSL_mod data table" = dv.listings::mod_data_table(
