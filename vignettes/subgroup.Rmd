...
To active this feature you must set `enable_subgroup = TRUE` in the `run_app` call.
...
<div class = "col-md-8">
  ...
  - Choose a variable name for the subgroup (2).
    ...
    <div class="alert alert-info">
    **Note:**  
    Variable names that are already present in the dataset are not allowed. If a previous subgroup had the same variable name
...
It is possible to create a subgroup with more than categories.
...
be created before loading data in the application.