...
dv.manager::run_app(
  ...
  module_list = list(
    ...
    "Simple" = dv.manager::mod_simple("adsl", "filtered_dataset",  "modSimp")
  ),
  filter_data = "adsl",
  filter_key = "USUBJID"
)
