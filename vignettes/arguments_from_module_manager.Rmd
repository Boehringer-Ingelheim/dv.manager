...
1. **utils**: a list of convenience functions:
    ...
    a. **switch2**: **DEPRECATED** a function that allows switching between tabs programatically.
...
Notice that as opposed to its predecessor `switch2`, `switch2mod` uses the module_id and not the name of the module tabs.
