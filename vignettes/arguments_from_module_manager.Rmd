...
mod_table <- function(table_name, mod_id) {
  mod <- list(
    ...
    server = function(afmm) {
      table_server(
        id = mod_id,
        dataset = shiny::reactive(get_filtered_data(afmm[["unfiltered_plus_filter_info"]](), table_name)[[table_name]])
      )
    },
    module_id = mod_id
  )
      ...
      table_server(
        ...
        dataset = shiny::reactive({
          if (!filtered) {
            ...
            get_filtered_data(afmm[["unfiltered_plus_filter_info"]](), dataset_names = table_name)[[table_name]]
          }
        })
      )
    },
