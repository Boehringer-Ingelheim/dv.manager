...
test_that(
  vdoc[["add_spec"]](
    "get_range_date should return the earliest and latest date from a vector",
...
test_that(
  vdoc[["add_spec"]](
    "get_range_date should warn when the list contains a NULL entry",
...
test_that(
  vdoc[["add_spec"]](
    "add_date_range should add date_range attribute to a dataset based on the dates of the data tables",
    c(specs$DATASETS$DATASET_LIST_MOD_DATE_RANGE)
  ),
  {
