...
knitr::opts_chunk$set(
  out.width = "100%",
  tidy = TRUE,
  echo = FALSE # no code is included
)
...
# This chunk is executed at the beginning of the report but its printing is deferred to the end of the report
load_data <- {
  function() {
...
```{r data_loading, eval=FALSE, echo=TRUE}
```
