...
local({
  ...
  args <- list(data = datasets, module_list = module_list, filter_data = "mpg", filter_key = "car", title = "Custom title", filter_type = "datasets")
  ...
  local({
    ...
    test_that(
        ...
        vdoc[["add_spec"]](c(specs$selected_dataset_name_access, specs$modification_dates_access, specs$module_name_access)),
      {
        ...
        ..switch_to_module("mod_dataset_name_date", app)
        app$wait_for_idle()
